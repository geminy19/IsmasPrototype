...
namespace IsmasPrototype.Controllers
{
    public class WorkListsController : Controller
    {
        ...
        {
            return View(await _context.WorkLists.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Sponsor,Employer,State,Capacity,Season")] WorkList workList)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Sponsor,Employer,State,Capacity,Season")] WorkList workList)
        {
            if (id != workList.Id)
            {
                return NotFound();
        ...
        {
            return _context.WorkLists.Any(e => e.Id == id);
        }
    }
}
